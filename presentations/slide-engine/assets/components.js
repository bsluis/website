...
// src/components/atoms/slide-title.js
var SlideTitle = class extends i4 {
  static styles = i`
    :host {
      display: block;
    }
...
// src/components/atoms/slide-content.js
var SlideContent = class extends i4 {
  static styles = i`
    :host {
      display: block;
    }
    .content {
      ...
      font-size: var(--text-body, 1.5rem);
...
// src/components/atoms/slide-navigation.js
var SlideNavigation = class extends i4 {
  static properties = {
    current: { type: Number },
    total: { type: Number }
  };
  static styles = i`
    ...
    button {
      ...
      border: none;
      cursor: pointer;
      color: var(--color-nav, inherit);
      font-size: var(--text-nav, 1rem);
  ...
  render() {
    return b2`
      <button
        ...
        @click=${() => this.#emit("slide-prev")}
      >&#8592;</button>
      <span class="count" aria-live="polite">${this.current} / ${this.total}</span>
      <button
        aria-label="Next slide"
        ?disabled=${this.current >= this.total}
        @click=${() => this.#emit("slide-next")}
      >&#8594;</button>
    `;
  }
};
customElements.define("slide-navigation", SlideNavigation);

// src/components/atoms/slide-progress.js
var SlideProgress = class extends i4 {
  static properties = {
    current: { type: Number },
    total: { type: Number }
  };
  static styles = i`
    :host {
      ...
      background: var(--color-progress-track, rgba(255,255,255,0.15));
    }
    .bar {
      height: 100%;
      background: var(--color-progress-bar, currentColor);
  ...
  get #percent() {
    return this.total > 1 ? (this.current - 1) / (this.total - 1) * 100 : 100;
  }
  render() {
    return b2`
      <div
...
customElements.define("slide-progress", SlideProgress);

// src/components/atoms/slide-logo-overlay.js
var SlideLogoOverlay = class extends i4 {
  static styles = i`
    :host {
      display: block;
      position: absolute;
      inset-block-end: var(--logo-bottom, 1.5rem);
      inset-inline-end: var(--logo-right, 2rem);
      display: flex;
  ...
  render() {
    return b2`
      <slot name="logo-primary"></slot>
      <slot name="logo-secondary"></slot>
    `;
  }
};
customElements.define("slide-logo-overlay", SlideLogoOverlay);

// src/components/molecules/slide-layout-single.js
var SlideLayoutSingle = class extends i4 {
  static styles = i`
    :host {
      display: grid;
...
customElements.define("slide-layout-single", SlideLayoutSingle);

// src/components/molecules/slide-layout-split.js
var SlideLayoutSplit = class extends i4 {
  static styles = i`
    :host {
      display: grid;
      grid-template-rows: auto 1fr;
...
customElements.define("slide-layout-split", SlideLayoutSplit);

// src/components/molecules/slide-layout-three-col.js
var SlideLayoutThreeCol = class extends i4 {
  static styles = i`
    :host {
      display: grid;
      grid-template-rows: auto 1fr;
    ...
    @media (max-width: 40rem) {
      ...
      .col { grid-column: 1; grid-row: auto; }
    }
  `;
  render() {
    return b2`
      <div class="title"><slot name="title"></slot></div>
      <div class="col"><slot name="col-1"></slot></div>
      <div class="col"><slot name="col-2"></slot></div>
      <div class="col"><slot name="col-3"></slot></div>
    `;
  }
};
customElements.define("slide-layout-three-col", SlideLayoutThreeCol);

// src/components/organisms/slide-title-page.js
var SlideTitlePage = class extends i4 {
  static properties = {
    current: { type: Number },
    total: { type: Number }
  };
  static styles = i`
    ...
    slide-navigation {
      position: absolute;
      inset-block-end: var(--space-md, 1.5rem);
  ...
  render() {
    return b2`
      <div role="main">
        <slide-progress .current=${this.current} .total=${this.total}></slide-progress>
        <slide-layout-single>
          <slide-title slot="title"><slot name="title"></slot></slide-title>
          <slide-content slot="content"><slot name="content"></slot></slide-content>
        </slide-layout-single>
        <slide-navigation .current=${this.current} .total=${this.total}></slide-navigation>
        <slide-logo-overlay>
          <slot name="logo-primary" slot="logo-primary"></slot>
          <slot name="logo-secondary" slot="logo-secondary"></slot>
        </slide-logo-overlay>
      </div>
    `;
  }
};
customElements.define("slide-title-page", SlideTitlePage);

// src/components/organisms/slide-content-image.js
var SlideContentImage = class extends i4 {
  static properties = {
    current: { type: Number },
    total: { type: Number }
  };
  ...
  render() {
    return b2`
      <div role="main">
        ...
        <slide-layout-split>
          <slide-title slot="title"><slot name="title"></slot></slide-title>
          <slide-content slot="left"><slot name="left"></slot></slide-content>
...
customElements.define("slide-content-image", SlideContentImage);

// src/components/organisms/slide-three-col.js
var SlideThreeCol = class extends i4 {
  static properties = {
    current: { type: Number },
    total: { type: Number }
  };
  static styles = i`
    ...
    slide-layout-three-col { height: 100%; }
    slide-progress {
      position: absolute;
      inset-block-start: 0;
      inset-inline-start: 0;
    ...
    return b2`
      <div role="main">
        ...
        <slide-layout-three-col>
          <slide-title slot="title"><slot name="title"></slot></slide-title>
          <slide-content slot="col-1"><slot name="col-1"></slot></slide-content>
          <slide-content slot="col-2"><slot name="col-2"></slot></slide-content>
          <slide-content slot="col-3"><slot name="col-3"></slot></slide-content>
        </slide-layout-three-col>
        <slide-navigation .current=${this.current} .total=${this.total}></slide-navigation>
        <slide-logo-overlay>
          <slot name="logo-primary" slot="logo-primary"></slot>
...
customElements.define("slide-three-col", SlideThreeCol);
